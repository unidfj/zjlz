        ...
        <section class="body">
            <form class="tj-form">
                ...
                <div class="form-item">
                    ...
                    <span class="error" v-show="!rule.isBank.validate"><i class="iconfont iconerror1">{{rule.isBank.msg}}</i></span>
                </div>
                <!-- <div class="form-item">
                ...
                <button type="button" class="btn-submit btn-blue" @click="add">添加</button>
            </form>
        </section>
